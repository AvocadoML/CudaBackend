...
namespace avocado
{
	namespace backend
	{
		...
		{
			GemmTester data(0, 23, 45, 67, AVOCADO_GEMM_OPERATION_N, AVOCADO_GEMM_OPERATION_N, AVOCADO_DTYPE_FLOAT16);
		...
		{
			GemmTester data(0, 23, 45, 67, AVOCADO_GEMM_OPERATION_N, AVOCADO_GEMM_OPERATION_T, AVOCADO_DTYPE_FLOAT16);
			float alpha = 1.1f, beta = 0.1f;
			double diff = data.getDifference(&alpha, &beta);
			EXPECT_LT(diff, epsilonForTest(AVOCADO_DTYPE_FLOAT16));
		}
		...
		{
			GemmTester data(0, 23, 45, 67, AVOCADO_GEMM_OPERATION_T, AVOCADO_GEMM_OPERATION_N, AVOCADO_DTYPE_FLOAT16);
			float alpha = 1.1f, beta = 0.1f;
			double diff = data.getDifference(&alpha, &beta);
			EXPECT_LT(diff, epsilonForTest(AVOCADO_DTYPE_FLOAT16));
		}
		...
		{
			GemmTester data(0, 23, 45, 67, AVOCADO_GEMM_OPERATION_T, AVOCADO_GEMM_OPERATION_T, AVOCADO_DTYPE_FLOAT16);
			float alpha = 1.1f, beta = 0.1f;
			double diff = data.getDifference(&alpha, &beta);
			EXPECT_LT(diff, epsilonForTest(AVOCADO_DTYPE_FLOAT16));
		}
...
//		{
//			GemmTester data(0, 23, 45, 67, AVOCADO_GEMM_OPERATION_N, AVOCADO_GEMM_OPERATION_N, AVOCADO_DTYPE_BFLOAT16);
//			float alpha = 1.1f, beta = 0.1f;
//			double diff = data.getDifference(&alpha, &beta);
...
//		{
//			GemmTester data(0, 23, 45, 67, AVOCADO_GEMM_OPERATION_N, AVOCADO_GEMM_OPERATION_T, AVOCADO_DTYPE_BFLOAT16);
//			float alpha = 1.1f, beta = 0.1f;
//			double diff = data.getDifference(&alpha, &beta);
//			EXPECT_LT(diff, epsilonForTest(AVOCADO_DTYPE_BFLOAT16));
//		}
...
//		{
//			GemmTester data(0, 23, 45, 67, AVOCADO_GEMM_OPERATION_T, AVOCADO_GEMM_OPERATION_N, AVOCADO_DTYPE_BFLOAT16);
//			float alpha = 1.1f, beta = 0.1f;
//			double diff = data.getDifference(&alpha, &beta);
//			EXPECT_LT(diff, epsilonForTest(AVOCADO_DTYPE_BFLOAT16));
//		}
...
//		{
//			GemmTester data(0, 23, 45, 67, AVOCADO_GEMM_OPERATION_T, AVOCADO_GEMM_OPERATION_T, AVOCADO_DTYPE_BFLOAT16);
//			float alpha = 1.1f, beta = 0.1f;
//			double diff = data.getDifference(&alpha, &beta);
//			EXPECT_LT(diff, epsilonForTest(AVOCADO_DTYPE_BFLOAT16));
//		}
