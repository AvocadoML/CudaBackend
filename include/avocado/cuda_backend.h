...
namespace avocado
{
	namespace backend
	{
		 ...
		 */
		DLL_PUBLIC avStatus_t cudaCopyMemory(avContextDescriptor_t context, avMemoryDescriptor_t dst, avSize_t dstOffset,
		 ...
		 */
		DLL_PUBLIC avStatus_t cudaConvolutionBackward(avContextDescriptor_t context, const avConvolutionDescriptor_t config, const void *alpha,
