...
namespace avocado
{
	namespace backend
	{
		...
		extern "C"
		{
			 ...
			 * \param[in] beta1
			 */
			DLL_PUBLIC avStatus_t cudaSetOptimizerSGD(avOptimizerDescriptor_t desc, double learningRate, bool useMomentum, bool useNesterov, double beta1);
			 ...
			 * \param[out] beta1
			 */
			DLL_PUBLIC avStatus_t cudaGetOptimizerSGD(avOptimizerDescriptor_t desc, double *learningRate, bool *useMomentum, bool *useNesterov, double *beta1);
			 ...
			 */
			DLL_PUBLIC avStatus_t cudaOptimizerLearn(avContextDescriptor_t context, const avOptimizerDescriptor_t config, const avTensorDescriptor_t wDesc,
