...
namespace avocado
{
	namespace backend
	{
		...
		extern "C"
		{
			 ...
			 * \param[in] flags
			 */
			DLL_PUBLIC avStatus_t cudaSetOptimizerDescriptor(avOptimizerDescriptor_t desc, avOptimizerType_t type, double learningRate,
			 ...
			 * \param[out] flags
			 */
			DLL_PUBLIC avStatus_t cudaGetOptimizerDescriptor(avOptimizerDescriptor_t desc, avOptimizerType_t *type, double *learningRate, double coefficients[],
					bool flags[]);
